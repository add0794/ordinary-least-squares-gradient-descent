...
from oop_methods import DataLoader, CustomLinearRegression, Visualizer, MemoryComparisonRegression

# python -m memory_profiler oop_methods.py -o my_memory_profile.txt

# python -m memory_profiler oop_version.py 
...
# lr_comparison = MemoryComparisonRegression(features_yes=yes_X, features_no=no_X, label=label, cols_yes=yes_cols, cols_no=no_cols)

# # Compare methods
# results_df = lr_comparison.compare_methods(
#     case='yes',
#     methods=['numpy', 'scipy', 'statsmodels', 'scikit-learn', 'ridge', 'lasso'],
#     ridge_alpha=100.0,
#     lasso_alpha=100.0
# )
